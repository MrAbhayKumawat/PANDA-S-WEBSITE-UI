        ...
        <section className="m-auto">
          <div className="flex flex-col  items-center justify-end ml-0">
            ...
            <div className="lg:w-[370px] xl:w-[370px] w-[350px] h-[450px] rounded-tl-[250px] rounded-tr-[250px] border border-neutral-200 mt-10 ">
              ...
              <div className="w-[] h-[115px] text-center  ">
                <span className="text-stone-900 lg:text-[28px] xl:text-[28px] text-[25px] font-medium font-['Jost']">
                  Create your free account
                </span>
                <span className="text-stone-900 text-[28px] font-medium font-['Jost']">
                  <br />
                </span>
                <span className="text-stone-900 lg:text-[25px] xl:text-[25px] text-[20px] font-medium font-['Jost']">
                  Takes less than
                </span>

                <span className="text-red-500 lg:text-[25px] xl:text-[25px] text-[22px] font-medium font-['Jost']">
                  &nbsp;5 minutes
                </span>
                <span className="text-stone-900 lg:text-[25px] xl:text-[25px] text-[22px] font-medium font-['Jost']">
                  ...
                </span>
              </div>

              <form
                className="flex justify-center flex-col items-center gap-y-3"
